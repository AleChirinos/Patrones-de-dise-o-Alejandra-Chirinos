...
public class Refrigerador implements IArtefactosElectronicosPequeno{
    private boolean factura;
    private double costo;
    private String marca;
    DecimalFormat formato= new DecimalFormat("#.00");

    public Refrigerador(boolean factura, double costo, String marca){
        this.costo=costo;
        this.marca=marca;
    ...
    public void tiempoDeGarantia() {
        if(marca.equals("SAMSUNG")){
            System.out.println("Garantia de 10 años SAMSUNG");
            System.out.println();
        }else{
            System.out.println("Garantia de 5 años "+marca);
            System.out.println();
        }
    }
}
